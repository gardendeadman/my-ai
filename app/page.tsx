    ...
    return (
      <div className="flex flex-col h-full bg-[#0f0f10] text-gray-100 items-center justify-center px-6">
        <div className="w-full max-w-sm text-center">
          ...
          <h1 className="text-2xl font-semibold text-white mb-2">나만의 AI</h1>
          <p className="text-gray-500 text-sm mb-10">로그인하고 AI 캐릭터와 대화를 시작해보세요</p>
          <button
            onClick={signInWithGoogle}
            className="w-full flex items-center justify-center gap-3 px-6 py-3.5 rounded-2xl bg-white text-gray-900 font-medium hover:bg-gray-100 transition-colors"
          >
